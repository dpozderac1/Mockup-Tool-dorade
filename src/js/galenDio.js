...
import "../js/desniToolbar"
import "../js/diplomski"
import "../js/evaluacija"
import "../js/pdf"
import "../js/poravnanje"
import { download } from "../js/snimanjeFajlova"
...
var udaljenostiSvakogElementaXGlobalni = [];
var jedanUnutarDrugogGlobalni = [];
var jedanDesnoOdDvaGlobalni = [];
var jedanLijevoOdDvaGlobalni = [];
var jedanIspodDvaGlobalni = [];
var jedanIznadDvaGlobalni = [];

var jedanRoditeljDvaGlobalni = []
var jedanDijeteDvaGlobalni = []
var zKoordinataGlobalni = []
...
function ocitajJeLiDijete() {
  sviSviElementi = document.getElementById("glavni").getElementsByTagName('div');
...
export {
  offset, bubbleSort, saveText, ocitajSveUdaljenosti, ocitajJeLiDijete, ocitajJeLiParent,
  razvrstajTestove, pretraziDaLiSuJedanUnutarDrugog, daLiJeDesnoOd, daLiJeIspodOd, daLiJeUnutar,
  napisiGalen, odrediZKoordinatu, pozoviFunkciju,
  udaljenostiSvakogElementaXGlobalni, jedanUnutarDrugogGlobalni, jedanDesnoOdDvaGlobalni,
  jedanLijevoOdDvaGlobalni, jedanIspodDvaGlobalni, jedanIznadDvaGlobalni, nizJedanUnutarDrugog
};*/
